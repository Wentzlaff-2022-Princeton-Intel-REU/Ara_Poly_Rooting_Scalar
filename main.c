...
int main() {
    ...
    for (int i = 2; i < 30; i++){
        ...
        if (i == 2) {
            ...
            poly.degree = 5;
            double inForArr[] = {4, -14, -22, 44, 24, 3};
            poly.coefficients = inForArr;
            double roots[poly.degree];
            double convCrit = 1e-14;
            ...
            poly.degree = 6;
            double inForArr[] = {-2, -19, -56, -56, -6, 3, -14};
            poly.coefficients = inForArr;
            double roots[poly.degree];
            double convCrit = 1e-14;
            ...
            poly.degree = 7;
            double inForArr[] = {4, -59, 285, -449, -787, 3856, -5024, 2200};
            poly.coefficients = inForArr;
            double roots[poly.degree];
            double convCrit = 1e-14;
            ...
            poly.degree = 8;
            double inForArr[] = {4, -53, 170, 295, -2793, 4637, 2431, -13137, 9438};
            poly.coefficients = inForArr;
            double roots[poly.degree];
            double convCrit = 1e-14;
            ...
            poly.degree = 9;
            double inForArr[] = {1, 29, 292, 1486, 3765, 2689, -7711, -16436, -8132, -409};
            poly.coefficients = inForArr;
            double roots[poly.degree];
            double convCrit = 1e-14;
            ...
            poly.degree = 12;
            double inForArr[] = {5, -47, -38, 1677, -2186, -22437, 41696, 143438, -270417, -439593, 695432, 473902, -649549};
            poly.coefficients = inForArr;
            double roots[poly.degree];
            double convCrit = 1e-14;
            ...
            poly.degree = 13;
            double inForArr[] = {3, -4, -115, 86, 1450, 42, -7018, -4993, 8591, 7676, -3684, -3506, 454, 375};
            poly.coefficients = inForArr;
            double roots[poly.degree];
            double convCrit = 1e-14;
            ...
            poly.degree = 14;
            double inForArr[] = {3, 33, 20, -756, -1814, 5082, 18247, -6307, -59552, -27416, 43750, 21673, -5705, 81, 21};
            poly.coefficients = inForArr;
            double roots[poly.degree];
            double convCrit = 1e-14;
            ...
            poly.degree = 15;
            double inForArr[] = {3, 38, 88, -920, -5007, 331, 50378, 80362, -144165, -466163, -133093, 699159, 800866, 195380, -102248, -41970};
            poly.coefficients = inForArr;
            double roots[poly.degree];
            double convCrit = 1e-14;
            ...
            poly.degree = 30;
            double inForArr[] = {16, 53, 57, 127, 148, 159, 183, 185, 196, 213, 236, 275, 293, 329, 363, 38248, 404, 551, 569, 610, 612, 658, 670, 705, 759, 72468, 82246, 863230, 932451, 102400};
            poly.coefficients = inForArr;
            double roots[poly.degree];
            double convCrit = 1e-14;
